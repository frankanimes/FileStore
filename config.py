...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7154392480:AAHBZNOtT1BsECi7RsbBRqrkp9helousbf0")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002122508523"))

# NAMA OWNER
OWNER = os.environ.get("OWNER", "Zeno")
...
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002023549953"))
...
try:
    ADMINS=[5806054139]
    for x in (os.environ.get("ADMINS", "5806054139").split()):
        ADMINS.append(int(x))
except ValueError:
...
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "<b>• ʙʏ @AnimeFactoryOfficial</b>")
